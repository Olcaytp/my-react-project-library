...
const filterNewRate = document.getElementById("filterDropdownNewRate");
...
//accessing the  dropdown list..
const genreFilter = document.getElementById("filterDropdown");
  
//Make a new array of all the genre types
function populateGenreFilter() {
  const AllGenreTypes = [
    ...new Set(books.map((book) => book.genre)),
  ];
  console.log(AllGenreTypes)

  //Add every genre type as an option to choose in the dropdown
  AllGenreTypes.forEach((genre) => {
...
//accessing the filterDropdownNewRat dropdown list..
const filterDropdownNewRat = document.getElementById("filterDropdownNewRate");

//add Newest, Oldest, Highest, Lowest as options to choose in the dropdown with same value
const populateNewRateFilter = () => {
  const NewRatFilter = [
    "Newest",
    "Oldest",
    "Highest Rating",
  ...
  NewRatFilter.forEach((filter) => {
    const option = document.createElement("option");
    option.value = filter;
    option.textContent = filter;

    filterDropdownNewRat.appendChild(option);
  });
};
...
// filter book from newest to oldest, from highest raiting to lowest raiting
const filterNewRateFunc = () => {
  ...
  if (value === "all") {
    ...
    const filteredList = sortOld(filteredBooks);
    displayBook(filteredList);
...
filterNewRate.addEventListener("change", filterNewRateFunc);
